...
const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Triangle = createLucideIcon("triangle", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function AppHeader({ activeTab, onTabChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-5 h-14 flex items-center gap-8", children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Triangle, { className: "w-5 h-5 fill-cyan text-cyan" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground tracking-tight", children: [
                "Arkhe",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan", children: "(n)" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1 flex-1", children: NAV_ITEMS.map(({ label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => onTabChange(label),
            "data-ocid": `nav.${label.toLowerCase()}.tab`,
            className: `flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium transition-all ${activeTab === label ? "text-cyan bg-cyan/10" : "text-muted-foreground hover:text-foreground hover:bg-white/5"}`,
            style: activeTab === label ? { filter: "drop-shadow(0 0 4px oklch(85% 0.18 200 / 0.5))" } : {},
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-7 h-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs bg-secondary text-foreground", children: "Ω" }) }),
...
function ArbitrageActivity() {
  const [sync, setSync] = reactExports.useState(98.6);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-4", children: "Live Arbitrage Activity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 flex-1", children: SEED_DATA.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: row.pair }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: row.time })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: row.exchange })
              ] })
            ]
          },
          row.pair
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-3 border-t border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Quorum Consensus" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium text-cyan", children: [
              sync,
              "% Synchronized"
            ] })
          ] }),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    width: `${sync}%`,
                    background: "linear-gradient(to right, oklch(60% 0.22 250), oklch(85% 0.18 200))",
...
function normalize(v2) {
  const len = Math.sqrt(v2[0] ** 2 + v2[1] ** 2 + v2[2] ** 2);
  return [v2[0] / len, v2[1] / len, v2[2] / len];
}
const VERTS = RAW_VERTS.map(normalize);
function rotateY(v2, a) {
  const cos = Math.cos(a);
  const sin = Math.sin(a);
  return [v2[0] * cos + v2[2] * sin, v2[1], -v2[0] * sin + v2[2] * cos];
}
function rotateX(v2, a) {
  const cos = Math.cos(a);
  const sin = Math.sin(a);
  return [v2[0], v2[1] * cos - v2[2] * sin, v2[1] * sin + v2[2] * cos];
}
function project(v2, scale, cx, cy) {
  const fov = 2.5;
  const z2 = v2[2] + fov;
  const x2 = v2[0] / z2 * scale + cx;
  const y = v2[1] / z2 * scale + cy;
  return [x2, y, z2];
}
function EEGManifold() {
  ...
  reactExports.useEffect(() => {
    ...
    function draw() {
      ...
      const rotated = VERTS.map((v2) => rotateX(rotateY(v2, a), a * 0.4));
      const projected = rotated.map((v2) => project(v2, scale, cx, cy));
      ...
      for (const [x2, y, z2] of projected) {
        const depth = (z2 - 2) / 1.5;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "eeg.card",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-4", children: "EEG Geometric Manifold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-4", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider mb-0.5", children: m.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-cyan", children: m.value })
            ]
          },
          m.label
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", "data-ocid": "eeg.canvas_target", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
          {
            ref: canvasRef,
            width: 260,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mt-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: m.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground", children: m.value })
        ] }, m.label)) })
      ]
    }
  );
...
const ICONS = [Zap, ChartNoAxesColumn, RefreshCw];
...
function OmegaCoherence() {
  const [coherence, setCoherence] = reactExports.useState(89.4);
  const [history, setHistory] = reactExports.useState(() => generateHistory(89));
  reactExports.useEffect(() => {
    const id = setInterval(() => {
  ...
  const W = 220;
  const H = 36;
  const pts = history.map((v2, i) => {
    const x2 = i / (HISTORY_SIZE - 1) * W;
    const y = H - (v2 - min) / range * H;
    return `${x2},${y}`;
  }).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-4", children: "Omega Prime Coherence" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: 180, height: 100, viewBox: "0 0 180 100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gaugeGrad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(60% 0.22 250)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(85% 0.18 200)" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            width: "100%",
            viewBox: `0 0 ${W} ${H}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: "● HIGH STABILITY"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-auto", children: ICONS.map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-3 h-3" })
          },
          Icon2.displayName ?? i
        )) })
      ]
...
function QuantumMethod() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-4", children: "Quantum Method" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 mb-5", children: [
        ...
        ].map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: row.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground", children: row.value })
        ] }, row.label)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: "linear-gradient(to right, oklch(60% 0.22 250 / 0.2), oklch(85% 0.18 200 / 0.2))",
...
function QuorumNodes() {
  const [activeNode, setActiveNode] = reactExports.useState(null);
  const [nodeCount] = reactExports.useState(147);
  const [pulseIdx, setPulseIdx] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const id = setInterval(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground", children: "Quantum Quorum Consensus Nodes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-cyan font-medium", children: [
              nodeCount,
              " Nodes Active"
            ] })
          ] })
              ...
              "svg",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "arcGrad1", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(65% 0.28 305 / 0.6)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(85% 0.18 200 / 0.6)" })
                    ] }),
                  ...
                  ARCS.map(([i, j], idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
                      d: cubicBezierPath(
                        CITIES[i].x,
                  ...
                  CITIES.map((city, i) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "g",
                      {
                        ...
                        children: [
                          isPulsing && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "circle",
                            {
                              cx: city.x,
                              cy: city.y,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "circle",
                            {
                              ...
                              cy: city.y,
                              r: isActive ? 4 : 3,
                              fill: isActive ? "oklch(85% 0.18 200)" : "oklch(80% 0.18 200 / 0.9)",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "text",
                            {
                              ...
                              textAnchor: "middle",
                              fontSize: "7",
                              fill: isActive ? "oklch(85% 0.18 200)" : "oklch(60% 0.04 270)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3 mt-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-cyan", children: s.value })
        ] }, s.label)) })
      ]
    }
  );
...
function RelayMonitor() {
  const [log2, setLog] = reactExports.useState(SEED_LOG);
  reactExports.useEffect(() => {
    const id = setInterval(() => {
      const entry = {
        hash: randHash(),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-1", children: "Transaction Relay Monitor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-foreground", children: "+283,786" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Global nodes" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1.5 mb-4 max-h-[160px] overflow-y-auto", children: log2.map((entry, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground", children: entry.hash }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground", children: entry.amount }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "100%", viewBox: "0 0 480 160", style: { display: "block" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
...
function SessionManagement() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-4", children: "Session Management" }),
...
function SystemPhase() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] uppercase tracking-widest text-muted-foreground mb-3 self-start", children: "System Phase Indicator" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-4xl font-bold tracking-widest",
            style: {
              background: "linear-gradient(135deg, oklch(65% 0.28 305), oklch(75% 0.2 250))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: 200, height: 200, viewBox: "0 0 200 200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "mandalaGrad", cx: "50%", cy: "50%", r: "50%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(65% 0.28 305 / 0.3)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(65% 0.28 305 / 0)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "arcGrad", x1: "0", y1: "0", x2: "1", y2: "1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(65% 0.28 305)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(85% 0.18 200)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx, cy, r: outerR + 8, fill: "url(#mandalaGrad)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx,
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "circle",
                {
                  ...
                  style: isActive ? { filter: "drop-shadow(0 0 5px oklch(65% 0.28 305))" } : {}
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx, cy, r: 10, fill: "oklch(65% 0.28 305 / 0.3)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Phase 4 · Geometric Crystallization" })
      ]
    }
  );
}
function ComingSoon({ tab }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-[60vh] text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-foreground mb-2", children: tab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Module under development. Coming soon." })
  ] });
}
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("Dashboard");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#060914" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppHeader, { activeTab, onTabChange: setActiveTab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-[1200px] mx-auto px-5 pt-8 pb-16", children: activeTab !== "Dashboard" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ComingSoon, { tab: activeTab }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-5 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(OmegaCoherence, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SystemPhase, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArbitrageActivity, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(EEGManifold, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(RelayMonitor, {})
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SessionManagement, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(QuantumMethod, {})
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(QuorumNodes, {})
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-5 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Arkhe(n) Platform · Constitutional Geometry Engine v2.0" }),
